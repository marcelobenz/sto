...
class HistorialTramiteDTO {
  ...
  // Getters
  // ───────────────────────────────────
  public function getIdHistorialTramite(): ?int { return $this->id_historial_tramite; }
  public function getFecha(): ?Carbon          { return $this->fecha; }
  public function getMensaje(): ?string        { return $this->mensaje; }
  public function getIdTramite(): int          { return $this->id_tramite; }
  public function getIdEvento(): int           { return $this->id_evento; }

  public function getIdEstadoActual(): ?int                { return $this->id_estado_actual; }
  public function getIdEstadoAnterior(): ?int              { return $this->id_estado_anterior; }
  public function getIdEstadoTramite(): ?int               { return $this->id_estado_tramite; }
  public function getIdUsuarioAdministrador(): ?int        { return $this->id_usuario_administrador; }
  public function getIdUsuarioAsignado(): ?int             { return $this->id_usuario_asignado; }
  public function getIdUsuarioInternoAdministrador(): ?int { return $this->id_usuario_interno_administrador; }
  public function getIdUsuarioInternoAsignado(): ?int      { return $this->id_usuario_interno_asignado; }

  // ───────────────────────────────────
  // Setters (devuelven void, estilo clásico)
  // ───────────────────────────────────
  public function setIdHistorialTramite(int $id): void        { $this->id_historial_tramite = $id; }
  public function setFecha(Carbon $fecha): void               { $this->fecha = $fecha; }
  public function setMensaje(string $mensaje): void           { $this->mensaje = $mensaje; }

  public function setIdEstadoActual(?int $id): void           { $this->id_estado_actual = $id; }
  public function setIdEstadoAnterior(?int $id): void         { $this->id_estado_anterior = $id; }
  public function setIdEstadoTramite(?int $id): void          { $this->id_estado_tramite = $id; }
  public function setIdUsuarioAdministrador(?int $id): void   { $this->id_usuario_administrador = $id; }
  public function setIdUsuarioAsignado(?int $id): void        { $this->id_usuario_asignado = $id; }
