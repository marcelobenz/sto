...
@section("content")
    <div class="container-fluid px-3">
        <div class="row mb-3 px-3" style="justify-content: end">
            ...
            <form
                method="GET"
                action="{{ route("secciones-multinota.crearNuevaSeccion") }}"
            >
                @csrf
                <button
                    type="submit"
                    id="boton-crear-seccion"
        ...
        function confirmarEliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    console.log(
                        'Se canceló desactivación de sección con ID: ' + id,
                    );
                }
            });
        }
