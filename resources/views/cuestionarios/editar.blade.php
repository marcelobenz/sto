...
<style>
    ...
    .usuarios-list { display: none; }
    .grupo-label { cursor: pointer; font-weight: bold; }
    .card-header .btn-link { text-decoration: none; width: 100%; text-align: left; }
</style>
@endsection
                    ...
                    <tbody>
                        @foreach($cuestionario->preguntas as $pregunta)
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="preguntas[{{ $pregunta->id_pregunta }}][descripcion]" value="{{ $pregunta->descripcion }}" class="form-control">
                                </td>
