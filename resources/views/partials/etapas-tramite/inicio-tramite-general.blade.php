        ...
        <div style="display: flex">
            @if (count($formulario->cuentas) > 0)
                <div class="col-md-3 col-xs-12">
                    <div class="form-group requerido">
                        ...
                        <select
                            ...
                            id="cuentasUsuario"
                            class="form-control"
                            onchange="mostrarInputCuenta(); guardarDatosDelSolicitante();"
                        >
                ...
                <div
                    ...
                    id="outputPanel"
                    style="
                        display: {{ $solicitante->cuenta !== "" && $otraSeleccionada ? "block" : "none" }};
                    "
                >
                    <div class="col-xs-12 no-padding">
                        <div class="form-group requerido">
                            <label for="cuentaGeneralSinCuentas">
                                Cuenta *
                            </label>
                            <input
                                required
                                type="text"
                                id="cuentaGeneralSinCuentas"
                                class="form-control uppercase"
                                name="cuentaGeneralSinCuentas"
                                value="{{ $solicitante->cuenta ?? "" }}"
