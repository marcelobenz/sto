<div>
  ...
  <div class="cuerpo-seccion-tramite" style="padding: 15px;">
    <div style="display: flex; justify-content: center; margin-bottom: 10px;">
      ...
      <button type="button" id="boton-subir-archivo" class="btn btn-secondary" style="background-color: #27ace3;">
          ...
          @foreach($archivos as $a)
            <tr>
              ...
              <td style="text-align: center;">
                <button class="boton-eliminar-archivo btn btn-danger" data-fecha="{{ $a['fechaCarga'] }}" style="margin: 5px;">
              ...
              <td style="text-align: center;">
                <input type="text" class="comentario" name="comentario" data-fecha="{{ $a['fechaCarga'] }}" value="{{ $a['comentario'] }}" />
              </td>
            </tr>
          @endforeach
        @else
