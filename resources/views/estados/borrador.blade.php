...
@section("content")
    <div class="container-fluid px-3">
        ...
        <br />
        <h2 class="mt-3">
            (BORRADOR)Crear Workflow de Estados - {{ $tipoTramite->nombre }}
        </h2>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($estados as $estado)
                                    <tr>
                                        ...
                                        <td>
                                            <button
                                                class="estado-btn btn btn-sm btn-info fa fa-search"
                        ...
                        <div class="mt-3">
                            ...
                            <div
                                id="form-nuevo-estado"
                                class="mt-2"
                                style="display: none"
                            >
                                <input
                                    type="text"
                                    id="input-nuevo-estado"
                                    class="form-control"
                                    placeholder="Nombre del nuevo estado"
                                />
                                <div class="mt-2 text-right">
                                    <button
                                        id="btn-confirmar-estado"
                                        class="btn btn-success btn-sm"
                                    >
                                        Confirmar
                                    </button>
                                    <button
                                        id="btn-cancelar-estado"
            ...
            <div class="col-md-8">
                <div id="seccion-relaciones" class="card" style="display: none">
                    <div class="card-header">
                        <h5>
                            Relaciones -
                            <span id="estado-actual-titulo"></span>
                        </h5>
                    </div>
                    <div class="card-body">
                        <label>
                        ...
                        <button id="btn-agregar" class="btn btn-primary mt-2">
                            Agregar
                        </button>
                        <div class="mt-3">
                            <h6>Posteriores</h6>
                ...
                >
                    ...
                    <div class="card-body">
                        <input type="checkbox" id="puede-rechazar" />
                        Puede rechazar
                        <br />
                        <input type="checkbox" id="puede-doc" />
                        Puede pedir documentación
                        <br />
                        <input type="checkbox" id="tiene-expediente" />
                        Tiene Expediente
                    </div>
                </div>

                <div
                    id="seccion-responsables"
                    class="card mt-3"
                    style="display: none"
                >
                    <div class="card-header">
