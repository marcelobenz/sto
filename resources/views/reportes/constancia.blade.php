    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="sub-header">
                {{ optional($tramiteInfo)->nombre ?? "Sin nombre" }}
            </div>
            ...
            <table>
                ...
                <tr>
                    ...
                    @if (isset($multinota->solicitante))
                        <td>
                            {{ $contribuyenteMultinota->apellido ?? "---" }}
                        </td>
                    @else
                        <td>
                            {{ $contribuyenteMultinota->apellido . ", " . $contribuyenteMultinota->nombre ?? "---" }}
                        </td>
                    @endif
                </tr>
            </table>
            @if (isset($multinota->solicitante))
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $multinota->solicitante->telefono ?? "---" }}
                        </td>
                    </tr>
                    <tr>
            ...
            <!-- Pie de Página -->
            <div class="footer">
                Por lo expuesto, se extiende la presente a pedido del interesado
                y al sólo efecto de servir como constancia de inicio de trámite.
            </div>
        </div>
    </body>
</html>
