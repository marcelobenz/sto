                    ...
                    <div class="card-body">
                        ...
                        >
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    type="text"
                                    class="form-control @error("legajo") is-invalid @enderror"
                                    id="legajo"
                                    name="legajo"
                                    value="{{ old("legajo") }}"
                                    required
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    type="text"
                                    class="form-control @error("correo_municipal") is-invalid @enderror"
                                    id="correo_municipal"
                                    name="correo_municipal"
                                    value="{{ old("correo_municipal") }}"
                                    required
                                />
                    ...
                    $.ajax({
                        ...
                        success: function (permisos) {
                            ...
                            if (permisos.length === 0) {
                                $('#permisos-body').append(
                                    '<tr><td colspan="2">No tiene permisos asignados.</td></tr>',
                                );
                            } else {
